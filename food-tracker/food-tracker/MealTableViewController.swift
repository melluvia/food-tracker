...
class MealTableViewController: UITableViewController {
    ...
    func loadSampleMeals() {
        ...
        let meal1 = MealData(name: "Pizza", photo: photo1, rating: 4, note: "A great Pizza!", restaurantName: "My Kitchen!!", prevRating: "4")!
        
        let photo2 = UIImage(named: "meal2")!
        let meal2 = MealData(name: "Chicken", photo: photo2, rating: 5, note: "Gotta Love Chicken!", restaurantName: "My mom's house", prevRating: "5")!
        
        let photo3 = UIImage(named: "meal3")!
        let meal3 = MealData(name: "Berry Salmon", photo: photo3, rating: 3, note: "Just average.", restaurantName: "Uncle Mike's", prevRating: "3")!
